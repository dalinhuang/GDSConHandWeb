...
public class UpdateNaviNodeAction extends ActionSupport implements ModelDriven<NaviNode>{

	/**
	 * 
	 */
	private static final long serialVersionUID = 8017808744952936495L;
	...
	public String input() throws Exception {
		...
		{
			currentNaviNode.setLabel(naviNode.getLabel());
			currentNaviNode.setMapId(naviNode.getMapId());
			currentNaviNode.setPlaceX(naviNode.getPlaceX());
			currentNaviNode.setPlaceY(naviNode.getPlaceY());

			NaviNodeRepositoryHibernate.saveNaviNode(currentNaviNode);
		}
