...
<html>
<head>
<title><s:text name="emergency.normal_notice" /></title>
...
<body>
	...
	<script>
			...
			function doOnLoad() {
				...
				dhxLayout.cells("a").setText("Normal Notice List");
				dhxLayout.cells("b").setText("Create New Normal Notice");
			...
			function initFormData() {
				dhxFormData = [ {
					...
					type : "input",
					name : "position",
					tooltip : "Enter Position ID Here",
					label : "Position ID",
					value : ""
				}, {
					type : "input",
			...
			function loadGrid() {
				...
				dhxGrid.setHeader("ID,Position ID,Message");
				dhxGrid.setColumnIds("id,position,message");
				dhxGrid.setInitWidths("200,200,*");
				dhxGrid.setColAlign("center,center,center");
				dhxGrid.setColTypes("ro,ed,ed");
				dhxGrid.setColSorting("int,int,str");
				...
				var serverUrl = "/wips/emergency/list_normal_notice.action";
