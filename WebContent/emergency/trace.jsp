...
<html>
<head>
<title><s:text name="emergency.trace" /></title>
...
<body>
	...
	<script>
			...
			function doOnLoad() {
				...
				dhxLayout.cells("a").setText("Trace List");
				dhxLayout.cells("b").setText("Trace Record is Read-Only");
			...
			function loadGrid() {
				...
				dhxGrid.setHeader("ID,MAC,Position ID,Time,From Signal");
				dhxGrid.setColumnIds("id,mac,position,time,from");
				dhxGrid.setInitWidths("200,200,200,300,*");
				dhxGrid.setColAlign("center,center,center,center,center");
				dhxGrid.setColTypes("ro,ro,ro,ro,ro");
				dhxGrid.setColSorting("int,str,int,date,str");
				...
				var serverUrl = "/wips/emergency/list_trace.action";
