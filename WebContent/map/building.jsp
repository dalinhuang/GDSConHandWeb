...
<html>
<head>
<title><s:text name="map.building_title" /></title>
...
<body>
	...
	<script>
			...
			function doOnLoad() {
				...
				dhxLayout.cells("a").setText("Building List");
				dhxLayout.cells("b").setText("Create New Building");
			...
			function loadGrid() {
				...
				dhxGrid.setHeader("ID,Category,Name,Latitude,Longitude,Maps");
				dhxGrid.setColumnIds("id,category,name,latitude,longitude,maps");
				dhxGrid.setInitWidths("100,200,400,120,120,*");
				dhxGrid.setColAlign("center,center,center,center,center,center");
				dhxGrid.setColTypes("ro,ed,ed,ed,ed,ed");
				dhxGrid.setColSorting("int,str,str,float,float,str");
				...
				var serverUrl = "/wips/map/list_building.action";
