...
<html>
<head>
<title><s:text name="map.position_title" /></title>
...
<body>
	...
	<script>
			...
			function doOnLoad() {
				...
				dhxLayout.cells("a").setText("Position List");
				dhxLayout.cells("b").setText("Position");
			...
			function loadGrid() {
				...
				dhxGrid.setHeader("ID,Map ID,Column ID,Row ID,Title Text,Title Text Rotation,Title Text Alpha,Title Text Scale,Description");
				dhxGrid.setColumnIds("id,mapId,colId,rowId,title,titleRotation,titleAlpha,titleScale,description");
				dhxGrid.setInitWidths("100,100,80,80,200,150,150,150,*");
				dhxGrid.setColAlign("center,center,center,center,center,center,center,center,center");
				dhxGrid.setColTypes("ro,ro,ro,ro,ed,ed,ed,ed,ed");
				dhxGrid.setColSorting("int,int,int,int,str,float,float,float,str");
				...
				var serverUrl = "/wips/map/list_position.action";
