...
<html>
<head>
<title><s:text name="map.map_title" /></title>
	...
	<div class="container-fluid1">
		...
		<script>
			...
			function doOnLoad() {
				...
				dhxLayout.cells("a").setText("Map List");
				dhxLayout.cells("b").setText("Creat New Map");
			...
			function loadGrid() {
				...
				dhxGrid.setHeader("ID,Name,Columns,Rows,Pixels per Cell,Version,Picture");
				dhxGrid.setColumnIds("id,name,columns,rows,pixels,version,thumbnailImgUrl");
				dhxGrid.setInitWidths("100,400,80,80,100,100,*");
				dhxGrid.setColAlign("center,center,center,center,center,center,center");
				dhxGrid.setColTypes("ro,ed,ed,ed,ed,ed,img");
				dhxGrid.setColSorting("int,str,int,int,int,str,str");
				...
				var serverUrl = "/wips/map/list_map.action";
