   ...
   .triangle-right {
	...
	<body style="overflow:auto">
		...
		<div id="header" style="position:absolute;left:0px;top:40px;z-index:4;overflow:hidden;width:1203px;height:40px;background:#f3f3f3;opacity:0.9">	
		     <div id="floornum"><p id="floortext">15F</p> </div>			 
			 <div id="pointtype"><p id="pointtypetext">仅显示导航点</p> </div>		 			 
			 <div id="coord"><p id="coordtext">X=0&nbsp;&nbsp;&nbsp;&nbsp;Y=0</p> </div>			 		 
			 <div id="zoomlimit"><p id="zoomtext">原图尺寸</p> </div>		 			 
        ...
        <button  type="button" onclick="deleteInterestPlace()" style="font:bold 14px 宋体;color:white">删&nbsp;除</button>
