...
<html>
<head>
<title><s:text name="nav.node_title" /></title>
...
<body>
	...
	<script>
			...
			function doOnLoad() {
				...
				dhxLayout.cells("a").setText("Navigation Node List");
				dhxLayout.cells("b").setText("Creat New Navigation Node");
			...
			function initFormData() {
				dhxFormData = [ {
					...
					name : "colId",
					label : "Column ID",
					tooltip : "Enter Column ID Here",
					value : ""
				}, {
					type : "input",
					name : "rowId",
					label : "Row ID",
					tooltip : "Enter Row ID Here",
					value : ""
				}, {
					type : "input",
					name : "name",
			...
			function loadGrid() {
				...
				dhxGrid.setHeader("ID,Map ID,Column ID,Row ID,Name");
				dhxGrid.setColumnIds("id,mapId,colId,rowId,name");
				dhxGrid.setInitWidths("200,200,120,120,*");
				dhxGrid.setColAlign("center,center,center,center,center");
				dhxGrid.setColTypes("ro,ed,ed,ed,ed");
				dhxGrid.setColSorting("int,int,int,int,str");
				...
				var serverUrl = "/wips/nav/list_node.action";
