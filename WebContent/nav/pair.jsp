...
<html>
<head>
<title><s:text name="nav.node_pair_title" /></title>
	...
	<script>
			...
			function initFormData() {
				dhxFormData = [ {
					...
					type : "input",
					name : "fromNode",
					tooltip : "Enter From Node ID Here",
					label : "From Node ID",
					value : ""
				}, {
					type : "input",
					name : "toNode",
					label : "To Node ID",
					tooltip : "Enter To Node ID Here",
					value : ""
				}, {
					type : "input",
					name : "distance",
					label : "Distance (M)",
					tooltip : "Enter Distance Here",
					value : ""
				}, {
					type : "input",
					name : "guideInfo",
					label : "Guide Text",
					tooltip : "Enter Guide Text Here",
					value : ""
				}, {
					type : "button",
					value : "Add",
			...
			function loadGrid() {
				...
				dhxGrid.setHeader("ID,From Node ID,To Node ID,Distance (M),Guide Text");
				dhxGrid.setColumnIds("id,fromNode,toNode,distance,guideInfo");
				dhxGrid.setInitWidths("200,200,200,200,*");
				dhxGrid.setColAlign("center,center,center,center,center");
				dhxGrid.setColTypes("ro,ed,ed,ed,ed");
				dhxGrid.setColSorting("int,int,int,float,str");
				...
				var serverUrl = "/wips/nav/list_pair.action";
